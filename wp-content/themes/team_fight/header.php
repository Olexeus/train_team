...
<head>
	...
	<meta property="og:title" content="Squadfight">
	<meta property="og:image" content="<?php  echo get_stylesheet_directory_uri(); ?>/img/logo-meta.png">
	<meta property="og:description" content="Squadfight.com - сайт-сервис специализирующийся на помощи в поиске напарников для сетевых видеоигр. ">
	<meta property="og:url" content="https://squadfight.com">
	...
	<link rel="stylesheet" href="<?php  echo get_stylesheet_directory_uri(); ?>/css/css/fonts.css" />
	<link rel="stylesheet" href="<?php  echo get_stylesheet_directory_uri(); ?>/css/css/main.css" />
	<link rel="stylesheet" href="<?php  echo get_stylesheet_directory_uri(); ?>/css/css/skins/tomato.css" />
	<link rel="stylesheet" href="<?php  echo get_stylesheet_directory_uri(); ?>/css/css/media.css" />
	<link rel="stylesheet" href="<?php  echo get_stylesheet_directory_uri(); ?>/style.css" />
	<link rel="icon" href="<?php  echo get_stylesheet_directory_uri(); ?>/img/favicon.ico">
	<?php wp_head(); ?>
	<?php include 'libs/chat/db.php'; ?>
</head>
<?php
	...
	<header>
		<div class="container mnu_line">
			...
			<div class="col-md-9 steam">
				...
				echo do_shortcode('[wp_steam_auth login_image="https://steamcommunity-a.akamaihd.net/public/images/signinthroughsteam/sits_02.png"]');
				...
				<li class="profile list_group">
                    ...
                    <ul>
						<li>
							<a href="#profile" class="list_ul_elem popup_content"><!-- <img class="icon" src="<?php // echo get_stylesheet_directory_uri(); ?>/img/icons/player_ico.svg" alt=""> -->Профиль</a>
							<?php 
								include 'libs/site_elements/profile_pop_up.php';
							?>
						</li>
						<li>
							<a href="#premium" class="list_ul_elem popup_content"><!-- <img class="icon" src="<?php // echo get_stylesheet_directory_uri(); ?>/img/icons/premium.svg" alt=""> -->Поддержка</a>
						</li>
						<li><?php echo '<a href="'.wpsap_button_logout_url().'" class="list_ul_elem"><!--<img class="icon" src="https://squadfight.com/wp-content/themes/team_fight/img/icons/logout.svg" alt="">-->Выйти</a>';?></li>
					</ul>
				</li>
				<?php } ?>
			</div>
