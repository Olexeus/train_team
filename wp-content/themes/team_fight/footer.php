	<footer>
		...
		<nav class="mnu_line_btm">
			<ul>
				<li><a class="popup_content" href="#about" >О нас</a></li>
				<li><a class="popup_content" href="#support" >Support</a></li>
				<li><a class="popup_content" id="premium2" href="#premium" >Поддержка</a></li>
				<li><a class="popup_content" href="#streamers" >Стримеры</a></li>
			</ul>
		</nav>
	</footer>
	...
	<?php
		...
		include 'libs/site_elements/streamers_pop_up.php';
	?>
    ...
    <script src="<?php  echo get_stylesheet_directory_uri(); ?>/js/adapter-latest.js"></script>
